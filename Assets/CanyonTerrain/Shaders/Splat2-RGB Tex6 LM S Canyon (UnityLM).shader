...
{
  vec4 tmpvar_1;
  tmpvar_1 = texture2D (unity_Lightmap, xlv_TEXCOORD0);
...
void main ()
{
  lowp vec4 lm2_1;
  lowp vec4 tmpvar_2;
  tmpvar_2 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD0));
  highp vec4 tmpvar_3;
...
void main ()
{
  ...
  shadow_2 = tmpvar_3;
  lowp vec4 tmpvar_9;
  tmpvar_9 = (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD0));
...
void main ()
{
  ...
  shadow_2 = tmpvar_3;
  lowp vec4 tmpvar_4;
  tmpvar_4 = texture2D (unity_Lightmap, xlv_TEXCOORD0);
  lowp vec4 tmpvar_5;
